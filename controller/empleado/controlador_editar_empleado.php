...
// Verificamos que lleguen todos los datos, incluyendo el ID
if (isset($_POST['id'], $_POST['dni'], $_POST['nombres'], $_POST['apePaterno'], $_POST['apeMaterno'], $_POST['email'])) {
    ...
    $resultado = $ME->EditarEmpleado($id, $dni, $nombres, $apePaterno, $apeMaterno, $email, $celular, $fecNacimiento, $direccion);
